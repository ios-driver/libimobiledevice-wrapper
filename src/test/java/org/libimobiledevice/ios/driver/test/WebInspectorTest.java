...
import org.libimobiledevice.ios.driver.binding.WebInspectorService;
...
//    for (int i = 0; i < 1; i++) {
//      final WebInspectorService service = device.getWebInspectorService();
...
//                          "</plist>" + "\n");
//
//      //System.out.println("got " + device.receiveMessage());
//
//      Thread.sleep(3000);
